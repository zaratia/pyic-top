...
if __name__ == '__main__':
    ...
    # call PET
    PET = PET_Hargreaves(
     avg_lat=AVG_LAT, n_hours=n_hours, hour_array=hour_array, year_array=year_array, 
     month_array=month_array, day_array=day_array, n_basin=n_basin,
     PET=PET, n_lapse=len(id_lapse_rate), basin_elev=basin_elev,
     basin_lapse=basin_lapse, t_intercept=t_intercept, t_slope=t_slope,
     ecf=ecf, dT_month=dt_month, id_lapse_rate=id_lapse_rate, t_idlapse=t_idlapse
     )
    ...
    (
        ...
        runoff, Qrunoff, soil_moisture, Qbase
            ...
            n_hours=n_hours, n_basin=n_basin, month_array=month_array,
            hour_array=hour_array, year_array=year_array, day_array=day_array,
            stg=stg, sgw=sgw, Cstar=Cstar, runoff=runoff,
            runoff_glac=runoff_glac, Qbase=Qbase,
            PET=PET, ET=ET, baseflow=baseflow, baseflow_glac=baseflow_glac, Qbase_type=QBASE_TYPE,
            cmin=cmin, cmax=cmax, stmax=stmax, stmin=stmin, b=b, be=be, bg=bg, q0=q0,
            m=m, kg=kg, ks=ks, k1=k1, k2=k2, k_glac=k_glac,
            Qglac_t1=Qglac_t1, Qglac_t2=Qglac_t2,
            Qrunoff_t1=Qrunoff_t1, Qrunoff_t2=Qrunoff_t2,
            Qrunoff=Qrunoff, Qglac=Qglac, soil_moisture=soil_moisture,
